...
<script language="JavaScript">
	function Excluir(id) {
			...
			if(confirm(msg)){  
			location.href="ExclusaoTaxonomia?nome_tabela=Reino&id_item="+id+"";  
			}else {  
											...
											<tr>
												...
												<font
													face="arial, verdana, helvetica">
														...
														<div id="styleone">
															<ul>
																<li><a href="DominioReino.jsp"class="current">Reino</a>
																</li>
																...
																<form method=post name=manter1>
																	<div id="tab" align="center">
																			...
																			<table>
																				...
																				<tr>
																					<input type=hidden name="nome_tabela" value="Reino">
																			...
																			<input type="hidden" name="nome_tabela" value="Reino"/>
																				<div id="tabela">
																					...
																					<tr>
																						...
																						<td><%=reinos.get(i).getNome()%></td>
																						<td><a href="#" onclick="Excluir('<%=reinos.get(i).Id()%>')"><img src="excluir (1).gif" /></a>
																						</td>
																						<td><a href="#" onclick="Excluir('<%=reinos.get(i).Id()%>')"><img src="edit.gif" /></a>
																						</td>
