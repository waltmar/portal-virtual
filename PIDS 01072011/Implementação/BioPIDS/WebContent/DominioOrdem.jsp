...
<script language="JavaScript">
	function Excluir(id) {
			...
			if(confirm(msg)){  
			location.href="ExclusaoTaxonomia?nome_tabela=Ordem&id_item="+id+"";  
			}else {  
													...
													face="arial, verdana, helvetica">
														...
														<div id="styleone">
															<ul>
																...
																<li><a href="DominioOrdem.jsp"class="current">Ordem</a>
																</li>
																...
																<form method=post name=manter1>
																	<div id="tab" align="center">
																			...
																			<table>
																				...
																				<tr>
																					<input type=hidden name="nome_tabela" value="Ordem">
																						<TD>Classe</TD>
																						<td><SELECT name="pai">
																								<%
																			...
																			<input type="hidden" name="nome_tabela" value="Ordem"/>
																				<div id="tabela">
																					...
																					<tr>
																						...
																						r.setId(ordens.get(i).getPai());
																						classe = ctrl.buscarItem(r);
																						
																						%>
																						<%=classe.getNome()%>
																						</td>
																						<td><%=ordens.get(i).getNome()%></td>
																						<td><a href="#" onclick="Excluir('<%=ordens.get(i).Id()%>')"><img src="excluir (1).gif" /></a>
																						</td>
																						<td><a href="#" onclick="Excluir('<%=ordens.get(i).Id()%>')"><img src="edit.gif" /></a>
																						</td>
