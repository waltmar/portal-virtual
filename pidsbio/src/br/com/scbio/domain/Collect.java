...
public class Collect implements Serializable {
	...
	private List<Collector> coletores;
	private String obsColeta;
	
	public Collect(){
		this.coletores = new ArrayList<Collector>();
	}
	...
	public List<Collector> getColetores() {
		return coletores;
	}
	public void setColetores(List<Collector> coletores) {
